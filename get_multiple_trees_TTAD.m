function  Multiple_Trees  = get_multiple_trees_TTAD(X, tree_size, tree_num, stop_seg_num)
% to construct multiple trees 
% Input:
% X£ºan HSI being processed;
% tree_size: subsampling size; tree_num: subsampling times; 
...
for i = 1:tree_num      
    ...
    Multiple_Trees(i,1) = {get_one_tree_TTAD(X_subset, height_limit, height_current, dimension_may_use, X, stop_seg_num)};     
