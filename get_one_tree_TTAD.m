 function  tree = get_one_tree_TTAD(X_subset,height_limit,height_current,dimension_may_use,X_original_subset, stop_seg_num)
% to get one tree
% Input:
...
if seg_valud_max == seg_valud_min     
    ...
    tree.left_node = get_one_tree_TTAD(X_left,height_limit,height_current,dimension_may_use,X_original_left, stop_seg_num);
    
    tree.right_node = get_one_tree_TTAD(X_right,height_limit,height_current,dimension_may_use,X_original_right, stop_seg_num);
end
